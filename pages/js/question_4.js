...
function generateQuiz(questions, quizContainer, resultsContainer, submitButton){
    ...
    if (numCorrect >= "3") {
      resultsContainer.innerHTML = numCorrect + " respostas corretas de " + questions.length + `<button onclick='window.open("prize.html", "_blank")' id='next' type='button'>Próximo</button>`;
      victory.play();
    } else {
